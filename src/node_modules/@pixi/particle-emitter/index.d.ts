...
export declare namespace ParticleUtils {
	 ...
	 */
	function rotatePoint(angle: number, p: IPointData): void;
	/**
	 ...
	 */
	function normalize(point: IPointData): void;
	/**
	 * Multiplies the x and y values of this point by a value.
	 * @param point The point to scaleBy
	 * @param value The value to scale by.
	 */
	function scaleBy(point: IPointData, value: number): void;
	/**
	 * Returns the length (or magnitude) of this point.
	 * @param point The point to measure length
	 * @return The length of this point.
	 */
	function length(point: IPointData): number;
	/**
